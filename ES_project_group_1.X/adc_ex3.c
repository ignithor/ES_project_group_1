...
//    adc_setup();
//    
//    // Send to UART frequency (10Hz instead of 5Hz)
//    tmr_setup_period(TIMER2, 100, 1);
//
//    while(1){
...
//
//void adc_setup(){
//    // Setup ADC: Automatic sampling & conversion at approximately 1kHz
